        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case FADEUP:
                    ...
                    break;
                case SERVER_DIED:
                    Log.w(TAG, "SERVER_DIED: mPlayPos = " + mPlayPos);
...
//                        mContentObserver);
                ...
                // but we just need unregisterReceiver once @{
		            MusicUtils.debugLog("Action shutdown [beg]");
                ...
                /// @}
                /// @}
		            MusicUtils.debugLog("Action shutdown [end]");
    ...
    public void open(long [] list, int position) {
        synchronized (this) {
            ...
            Log.d(TAG, "open() list = " + ((list != null) ? list : "null") + ",position = "
     ...
     */
    public void play() {
        Log.d(TAG, ">> play: init=" + mPlayer.isInitialized());
        ...
        if (mPlayer.isInitialized()) {
            ...
            mPlayer.start();
            Log.d(TAG, "MediaPlayer start done.");
    ...
    private void stop(boolean remove_status_icon) {
        Log.d(TAG, "stop(" + remove_status_icon + ")");
    ...
    public long duration() {
        ...
        Log.i(TAG, "duration from MediaPlayer is " + duration);
        return duration;
    }
    ...
    private class MultiPlayer {
        ...
        private boolean setDataSourceImpl(MediaPlayer player, String path) {
            try {
                ...
                Log.e(TAG, "setDataSourceImpl: " + ex);
                return false;
        ...
        public void setNextDataSource(String path) {
            Log.d(TAG, "setNextDataSource: path = " + path + ", mNextPlayPos = " + mNextPlayPos);
        ...
        MediaPlayer.OnCompletionListener listener = new MediaPlayer.OnCompletionListener() {
            public void onCompletion(MediaPlayer mp) {
                if (mp == mCurrentMediaPlayer && mNextMediaPlayer != null) {
                    Log.d(TAG, "onCompletion: Auto switch to Next MediaPlayer");
                    mCurrentMediaPlayer.release();
                    ...
                    Log.d(TAG, "onCompletion: send Track End");
    ...
    private void scanBackward(long delta) {
        ...
        long scanDelta = 0;
        Log.d(TAG, "scanBackward(),delta:" + delta);
    ...
    private void scanForward(long delta) {
       Log.d(TAG, "scanForward(),delta:" + delta);
        long scanDelta = 0;
        long startSeekPos = position();
        if (delta < POSITION_FOR_SPEED_FAST) {
            /// M: seek at 10x speed for the first 5 seconds
    ...
    private boolean isEventFromMonkey() {
        ...
        Log.v(TAG, "isEventFromMonkey " + isMonkey);
        return isMonkey;
    }
}
