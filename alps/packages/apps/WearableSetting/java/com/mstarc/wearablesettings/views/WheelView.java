...
public class WheelView extends View {
    ...
    public static final int DEFAULT_MASK_DARK_COLOR = 0x000000;
    public static final int DEFAULT_MASK_LIGHT_COLOR = 0x000000;
    /**
     * 控件宽度
     */
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        lineColor = attribute.getColor(R.styleable.WheelView_lineColors, lineColor);
