...
public class A2dpService extends ProfileService {
    ...
    private static final String TAG="[BT][A2DP]A2dpService";
    ...
    public boolean connect(BluetoothDevice device) {
        ...
        log("begin to connect , dev " + device.getAddress());
    ...
    boolean disconnect(BluetoothDevice device) {
        enforceCallingOrSelfPermission(BLUETOOTH_ADMIN_PERM,
                                       "Need BLUETOOTH ADMIN permission");
        log("begin to disconnect , dev " + device.getAddress());
    ...
    int getConnectionState(BluetoothDevice device) {
        enforceCallingOrSelfPermission(BLUETOOTH_PERM, "Need BLUETOOTH permission");
        if (mStateMachine == null) {
            Log.d(TAG, "[getConnectionState] mStateMachine is NULL, return STATE_DISCONNECTED");
