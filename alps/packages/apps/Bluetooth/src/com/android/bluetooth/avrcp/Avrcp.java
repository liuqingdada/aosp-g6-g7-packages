...
public final class Avrcp {
    ...
    private static final String TAG = "[BT][AVRCP]Avrcp";
    ...
    private final class AvrcpMessageHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            Log.d(TAG, "[AvrcpMessageHandler][handleMessage] msg : " + msg.what);
            switch (msg.what) {
    ...
    private void updateA2dpAudioState(int state) {
        Log.d(TAG, "[updateA2dpAudioState] state : " + state);
    ...
    private void updateTransportControls(int transportControlFlags) {
        Log.d(TAG, "[updateTransportControls] transportControlFlags : " + transportControlFlags);
    ...
    private void updateMetadata(MetadataEditor data) {
        ...
        mSongLengthMs = data.getLong(MediaMetadataRetriever.METADATA_KEY_DURATION,
                RemoteControlClient.PLAYBACK_POSITION_INVALID);
        if (DEBUG) Log.d(TAG, "[updateMetadata] duration=" + mSongLengthMs);
    }
    ...
    private void handlePassthroughCmd(int id, int keyState) {
        Log.d(TAG, "[handlePassthroughCmd] id : " + id + ", keyState : " + keyState);
        switch (id) {
    ...
    private long getPlayPosition() {
        ...
        if (DEBUG) Log.d(TAG, "[getPlayPosition] position=" + songPosition);
        return songPosition;
    }
