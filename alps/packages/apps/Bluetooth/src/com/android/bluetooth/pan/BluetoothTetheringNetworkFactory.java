...
/*                LinkProperties linkProperties;
                ...
                /// M: Fix ALPS02092094 @{
                /// When the PAN connection state change from Connected to Disconencted
                /// The interface name will be cleared, but the value will be tranfer to runDhcp method
                /// this will cause NE
                /// M @}
                String interfaceName = mLinkProperties.getInterfaceName();
                log("interfaceName : " + interfaceName);
                if (TextUtils.isEmpty(interfaceName)) {
                    log("interfaceName is NULL or EMPTY");
                    return;
                }
                ...
                // noticing.
                if (!NetworkUtils.runDhcp(interfaceName, dhcpResults)) {
                ...
                synchronized(BluetoothTetheringNetworkFactory.this) {
                    mLinkProperties = dhcpResults.toLinkProperties(interfaceName);
