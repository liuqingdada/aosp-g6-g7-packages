...
public class AvrcpControllerService extends ProfileService {
    ...
    private static final String TAG = "[BT][AVRCP]AvrcpControllerService";
    ...
    public void sendPassThroughCmd(BluetoothDevice device, int keyCode, int keyState) {
        if (DBG) Log.d(TAG, "sendPassThroughCmd : " + device
    ...
    private void onConnectionStateChanged(boolean connected, byte[] address) {
        ...
        Log.d(TAG, "[onConnectionStateChanged] connected : " + connected + " " + device);
...
//        intent.addFlags(Intent.FLAG_RECEIVER_REGISTERED_ONLY_BEFORE_BOOT);
    ...
    private void handlePassthroughRsp(int id, int keyState) {
        Log.d(TAG, "[handlePassthroughRsp] passthrough response received as: key: "
                                + id + " state: " + keyState);
    }
