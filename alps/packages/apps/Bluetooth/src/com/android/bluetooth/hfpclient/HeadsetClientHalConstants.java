...
final public class HeadsetClientHalConstants {
    ...
    final static int HANDSFREECLIENT_AT_CMD_IPHONE_XAPL = 16;
    final static int HANDSFREECLIENT_AT_CMD_IPHONE_BATTERY_STATUS = 17;

    // Flag to check for local NREC support
    final static boolean HANDSFREECLIENT_NREC_SUPPORTED = true;
    final static boolean HANDSFREECLIENT_IPHONE_BATTERY_STATUS_SUPPORTED = false;
}
