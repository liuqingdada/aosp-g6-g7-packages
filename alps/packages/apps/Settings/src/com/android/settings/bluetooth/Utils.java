...
final class Utils {
    ...
    public static boolean isWearSettingsExist(Context context) {
        boolean isWearSettingsExist = true;
        try {
            PackageManager pm = context.getPackageManager();
            pm.getPackageInfo("com.mediatek.wear.settings", 0);
        } catch (NameNotFoundException e) {
            isWearSettingsExist = false;
        }
        return isWearSettingsExist;
    }
}
