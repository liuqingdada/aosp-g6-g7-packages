...
public final class BluetoothPairingRequest extends BroadcastReceiver {
    ...
    private static final String TAG = "[AOSP]BluetoothPairingRequest";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        Log.d(TAG, "[AOSP]Received " + action);
        ...
        if (action.equals(BluetoothDevice.ACTION_PAIRING_REQUEST)) {
            ...
            boolean isInForeground = LocalBluetoothPreferences.shouldShowDialogInForeground(
                                context, deviceAddress);
            Log.d(TAG, "isScreenOn : " + isScreenOn  + " isInForeground : " + isInForeground);
         //jason   if (isScreenOn && isInForeground) {
          if (isScreenOn ) {
