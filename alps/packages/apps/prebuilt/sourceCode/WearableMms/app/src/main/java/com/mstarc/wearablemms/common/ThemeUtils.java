...
public class ThemeUtils {
    ...
    private final static String PRODUCT_COLOR_ROSE_GOLDEN = "1";
    private final static String PRODUCT_COLOR_HIGH_BLACK = "2";
    private final static String PRODUCT_COLOR_APPLE_GREEN = "3";
...
//        if (true) {
    ...
    public static void updateImageView(final ImageView view, final int resId) {
        view.post(new Runnable() {
            @Override
            public void run() {
                int color = getCurrentPrimaryColor();
