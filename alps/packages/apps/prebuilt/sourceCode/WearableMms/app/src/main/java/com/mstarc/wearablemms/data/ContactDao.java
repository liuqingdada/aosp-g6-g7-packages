...
public class ContactDao {
   ...
   //通过号码获取联系人头像
    ...
    public static String getUriByAddress(ContentResolver resolver,String address){
        ...
        if (cursor.moveToFirst()){
            String _id = cursor.getString(0);
            //获取联系人的照片
            bitmapUri = Uri.withAppendedPath(ContactsContract.Contacts.CONTENT_URI,_id).toString();
        }
        return bitmapUri;
    }
}
