	...
	private OnErrorListener mErrorListener = new OnErrorListener()
	{
		public boolean onError(MediaPlayer mp, int framework_err, int impl_err)
		{
			...
			if (getWindowToken() != null)
			{
				...
				Log.e("resulttt", "---------------播放遇到问题----------------" + message);
				// new
				// AlertDialog.Builder(mContext).setTitle(getResources().getIdentifier("VideoView_error_title",
				// "string",
				// mContext.getPackageName())).setMessage(message).setPositiveButton(getResources().getIdentifier("VideoView_error_button",
				// "string", mContext.getPackageName()), new
