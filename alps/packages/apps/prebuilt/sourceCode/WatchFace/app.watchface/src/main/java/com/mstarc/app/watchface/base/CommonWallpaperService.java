...
import com.mstarc.app.watchface.utils.IntenetUtil;
import com.mstarc.app.watchface.utils.Logger;
import com.mstarc.app.watchface.utils.WeakHandler;
    ...
    protected abstract class CommonWallpaperEngine extends Engine
        ...
        public void onCreate(SurfaceHolder surfaceHolder) {
            ...
            try {
                ...
                Logger.e(TAG, "onCreate: no target step set, use default.\n", e);
            }

            try {
                mSteps = Settings.System.getInt(getContentResolver(), SETTINGS_SPORT_STEPS_CURRENT);
            } catch (Settings.SettingNotFoundException e) {
                mSteps = 0;
                Logger.e(TAG, "onCreate: no current step set, use default.\n", e);
            }
