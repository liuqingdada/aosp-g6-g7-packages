...
//    private int mWaveColor = getContext().getResources().getColor(R.color.main_highlight);
    private int mWaveColor = ThemeUtils.getCurrentPrimaryColor();
    private int mSecondWaveColor = 0xCCF8CE71;
