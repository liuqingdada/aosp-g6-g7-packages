...
public class PowerConfirmDialog extends Dialog {
    int mLayoutId;
    ...
    Listener mListener;
    private static final String TAG = PowerConfirmDialog.class.getSimpleName();

    public PowerConfirmDialog(Context context, Listener listener, String text) {
    ...
    public PowerConfirmDialog(Context context, Listener listener, int layoutId) {
        super(context, R.style.Dialog);
        mListener = listener;
        mLayoutId = layoutId;
        mHandle = new DialogHandler();
