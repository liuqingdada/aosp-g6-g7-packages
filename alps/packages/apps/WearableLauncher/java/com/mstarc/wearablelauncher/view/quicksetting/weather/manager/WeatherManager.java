package com.mstarc.wearablelauncher.view.quicksetting.weather.manager;
...
import com.mstarc.wearablelauncher.view.quicksetting.weather.Utils.WeatherUtils;
...
public class WeatherManager implements IWeather.OnGetWeatherListener {
    ...
    private void parseRawData(String data) {
        try {
            Log.d(TAG, "parseRawData data : " + data);
    ...
    public int getLocationIcon(int locationProperty) {
        switch (locationProperty) {
            ...
            case WeatherUtils.LOCATION_HOME:
                return R.drawable.icon_changzhudi;
        }
        return -1;
    }
        ...
        switch (type) {
            case 0:
                if (big) {
                    ...
                    return R.drawable.icon_weather_small_0;
                }
            case 1:
                if (big) {
                    return R.drawable.icon_weather_1;
                } else {
                    return R.drawable.icon_weather_small_1;
                }
            case 2:
                if (big) {
                    return R.drawable.icon_weather_2;
                } else {
                    return R.drawable.icon_weather_small_2;
                }
            case 3:
                if (big) {
                    return R.drawable.icon_weather_3;
                } else {
                    return R.drawable.icon_weather_small_3;
                }
            case 4:
                //case WeatherUtils.TYPE_WEATHER_QIANGSHACHENBAO:
                if (big) {
                    return R.drawable.icon_weather_4;
                } else {
                    return R.drawable.icon_weather_small_4;
                }
            case 5:
                if (big) {
                    return R.drawable.icon_weather_5;
                } else {
                    return R.drawable.icon_weather_small_5;
                }
            case 6:
                if (big) {
                    return R.drawable.icon_weather_6;
                } else {
                    return R.drawable.icon_weather_small_6;
                }
            case 7:
                //case WeatherUtils.TYPE_WEATHER_DAXUEBAOXUE:
                //case WeatherUtils.TYPE_WEATHER_BAOXUE:
                if (big) {
                    return R.drawable.icon_weather_7;
                } else {
                    return R.drawable.icon_weather_small_7;
                }
            case 8:
                //case WeatherUtils.TYPE_WEATHER_ZHONGXUEDAXUE:
                if (big) {
                    return R.drawable.icon_weather_8;
                } else {
                    return R.drawable.icon_weather_small_8;
                }
            case 9:
                //case WeatherUtils.TYPE_WEATHER_ZHENXUE:
                //case WeatherUtils.TYPE_WEATHER_XIAOXUEZHONGXUE:
                if (big) {
                    return R.drawable.icon_weather_9;
                } else {
                    return R.drawable.icon_weather_small_9;
                }
            case 10:
                ...
                if (big) {
                    ...
                    return R.drawable.icon_weather_small_10;
                }
            case 11:
                if (big) {
                    return R.drawable.icon_weather_11;
                } else {
                    return R.drawable.icon_weather_small_11;
                }
            case 12:
                ...
                if (big) {
                    return R.drawable.icon_weather_12;
                } else {
                    return R.drawable.icon_weather_small_12;
                }
            case 13:
                ...
                if (big) {
                    ...
                    return R.drawable.icon_weather_small_13;
                }
            case 14:
                ...
                if (big) {
                    ...
                    return R.drawable.icon_weather_small_14;
                }
            case 15:
                //case WeatherUtils.TYPE_WEATHER_XIAOYUZHONGYU:
                if (big) {
                    return R.drawable.icon_weather_15;
                } else {
                    return R.drawable.icon_weather_small_15;
                }
            case 16:
                if (big) {
                    return R.drawable.icon_weather_16;
                } else {
                    return R.drawable.icon_weather_small_16;
                }
            case 17:
                if (big) {
                    return R.drawable.icon_weather_17;
                } else {
                    return R.drawable.icon_weather_small_17;
                }
            case 18:
                if (big) {
                    return R.drawable.icon_weather_18;
                } else {
                    return R.drawable.icon_weather_small_18;
                }
            case 19:
                if (big) {
                    return R.drawable.icon_weather_19;
                } else {
                    return R.drawable.icon_weather_small_19;
                }
            case 20:
                if (big) {
                    return R.drawable.icon_weather_20;
                } else {
                    return R.drawable.icon_weather_small_20;
                }
            case 21:
                if (big) {
                    return R.drawable.icon_weather_21;
                } else {
                    return R.drawable.icon_weather_small_21;
                }
            case 22:
                if (big) {
                    return R.drawable.icon_weather_22;
                } else {
                    return R.drawable.icon_weather_small_22;
                }
            case 23:
                if (big) {
                    return R.drawable.icon_weather_23;
                } else {
                    return R.drawable.icon_weather_small_23;
                }
            case 24:
                if (big) {
                    return R.drawable.icon_weather_24;
                } else {
                    return R.drawable.icon_weather_small_24;
                }
            case 25:
                if (big) {
                    return R.drawable.icon_weather_25;
                } else {
                    return R.drawable.icon_weather_small_25;
                }
            case 26:
                if (big) {
                    return R.drawable.icon_weather_26;
                } else {
                    return R.drawable.icon_weather_small_26;
                }
            case 27:
                if (big) {
                    return R.drawable.icon_weather_27;
                } else {
                    return R.drawable.icon_weather_small_27;
                }
            case 28:
                if (big) {
                    return R.drawable.icon_weather_28;
                } else {
                    return R.drawable.icon_weather_small_28;
                }

            case 29:
                if (big) {
                    return R.drawable.icon_weather_29;
                } else {
                    return R.drawable.icon_weather_small_29;
                }
            case 30:
                if (big) {
                    return R.drawable.icon_weather_30;
                } else {
                    return R.drawable.icon_weather_small_30;
                }
            case 31:
                if (big) {
                    return R.drawable.icon_weather_31;
                } else {
                    return R.drawable.icon_weather_small_31;
                }
            case 32:
                if (big) {
                    return R.drawable.icon_weather_32;
                } else {
                    return R.drawable.icon_weather_small_32;
                }


            case 49:
                if (big) {
                    return R.drawable.icon_weather_49;
                } else {
                    return R.drawable.icon_weather_small_49;
                }
            case 53:
                if (big) {
                    return R.drawable.icon_weather_53;
                } else {
                    return R.drawable.icon_weather_small_53;
                }
            case 54:
                if (big) {
                    return R.drawable.icon_weather_54;
                } else {
                    return R.drawable.icon_weather_small_54;
                }
            case 55:
                if (big) {
                    return R.drawable.icon_weather_55;
                } else {
                    return R.drawable.icon_weather_small_55;
                }
            case 56:
                if (big) {
                    return R.drawable.icon_weather_56;
                } else {
                    return R.drawable.icon_weather_small_56;
                }
            case 57:
                if (big) {
                    return R.drawable.icon_weather_57;
                } else {
                    return R.drawable.icon_weather_small_57;
                }

            case 58:
                if (big) {
                    return R.drawable.icon_weather_58;
                } else {
                    return R.drawable.icon_weather_small_58;
                }
            case 99:
                if (big) {
                    return R.drawable.icon_weather_99;
                } else {
                    return R.drawable.icon_weather_small_99;
                }
            case 301:
                if (big) {
                    return R.drawable.icon_weather_301;
                } else {
                    return R.drawable.icon_weather_small_301;
                }

            case 302:
                if (big) {
                    return R.drawable.icon_weather_302;
                } else {
                    return R.drawable.icon_weather_small_302;
                }
            default:
                return -1;
        }
    ...
    public int getIconBasedOnQuality(int weatherQuality) {
        if (weatherQuality > 0 && weatherQuality <= 50) {
            return R.drawable.icon_kongqi_you;
        } else if (weatherQuality > 50 && weatherQuality <= 100) {
            return R.drawable.icon_kongqi_liang;
        } else if (weatherQuality > 100 && weatherQuality <= 150) {
            return R.drawable.icon_kongqi_qingdu;
        } else if (weatherQuality > 150 && weatherQuality <= 200) {
            return R.drawable.icon_kongqi_zhongdu_small;
        } else if (weatherQuality > 200 && weatherQuality <= 300) {
            return R.drawable.icon_kongqi_zhongdu_big;
        } else if (weatherQuality > 300) {
            return R.drawable.icon_kongqi_yanzhong;
        }
        return -1;
    }
