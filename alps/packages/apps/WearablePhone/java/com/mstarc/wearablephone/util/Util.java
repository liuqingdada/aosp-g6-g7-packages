...
public final class Util {
    ...
    private static Bitmap createWhiteBitmap() {
        Bitmap whiteBitmap = Bitmap.createBitmap(Constants.APP_ICON_WIDTH,
                                                 Constants.APP_ICON_HEIGHT, Config.RGB_565);
        ...
        whiteBitmap.setPixels(pixels, 0, Constants.APP_ICON_WIDTH, 0, 0, Constants.APP_ICON_WIDTH,
                              Constants.APP_ICON_HEIGHT);
        return whiteBitmap;
    }
    ...
    public static boolean isScreenLocked(Context context) {
        ...
        Log.i(LOG_TAG, "isScreenLocked(), isScreenLocked=" + isScreenLocked);
    ...
    private static Bitmap resizeBitmapByScale(Bitmap bitmap, float widthScale, float heightScale) {
        Log.i(LOG_TAG,
              "resizeBitmapByScale(), widthScale=" + widthScale + ", heightScale=" + heightScale);
    ...
    public static String getContactName(Context context, String phoneNum) {
        ...
        if (phoneNum == null || phoneNum.equals("")) {
            ...
            try {
                ...
                Log.e(LOG_TAG, "getContactName Exception");
            }
        }
        return contactName;
    }
