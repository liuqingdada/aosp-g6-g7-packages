...
public class InCallPresenter implements CallList.Listener, InCallPhoneListener {
    ...
    public void onCallListChange(CallList callList) {
        ...
        //Call call = calls.getIncomingCall();
        //if (call != null) {
        //    if (InterceptCall.getInstance().isIntercept(call.getNumber())) {
        //        InterceptCall.getInstance().intercept();
        //        return;
        //    }
        //}
    ...
    private InCallState startOrFinishUi(InCallState newState) {
        ...
        final boolean mainUiNotVisible = !isShowingInCallUi();
