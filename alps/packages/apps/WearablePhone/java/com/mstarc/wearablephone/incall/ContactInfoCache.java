...
import com.mstarc.wearablephone.incall.PhoneNumberService;
import com.mstarc.wearablephone.incall.ServiceFactory;
    ...
    public Drawable getDefaultContactPhotoDrawable() {
        if (mDefaultContactPhotoDrawable == null) {
            mDefaultContactPhotoDrawable =
                    mContext.getResources().getDrawable(R.drawable.ic_phone_default_profile_tinted, mContext.getTheme());
        }
