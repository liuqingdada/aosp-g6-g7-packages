...
import com.mstarc.g6.watchface.weather.Weather;
import com.mstarc.g6.watchface.weather.manager.WeatherManager;
...
abstract public class CanvasWatchFaceService extends WallpaperService {
    ...
    public abstract class Engine extends WallpaperService.Engine implements WeatherManager.DataLoadListener {
        ...
        /**
         * 0 is not have simCard, else update signal level
         */
        ...
        class SettingsContentObserver extends ContentObserver {
            ...
            public void onChange(boolean selfChange, Uri uri) {
                ...
                else if(uri.equals(android.provider.Settings.System.getUriFor(SETTINGS_SPORT_STEPS_CURRENT))){
                    try {
                        mSteps = android.provider.Settings.System.getInt(getContentResolver(), SETTINGS_SPORT_STEPS_CURRENT);
        ...
        /**
         * @return level range of [0, WIFI_ICON_LEVELS); 100 is wifi unnable or not connect
         */
...
//            }
        ...
        int getSteps() {
            if (isSport) {
                Log.d(TAG, "getSteps: mSportStep = " + mSportStep);
                return mSportStep;
            } else {
                Log.d(TAG, "getSteps: mSteps = " + mSteps);
                return mSteps;
            }
        }
