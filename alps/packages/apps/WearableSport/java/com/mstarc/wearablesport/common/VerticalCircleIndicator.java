...
public class VerticalCircleIndicator extends LinearLayout {
    ...
    public VerticalCircleIndicator(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public VerticalCircleIndicator(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public VerticalCircleIndicator(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
