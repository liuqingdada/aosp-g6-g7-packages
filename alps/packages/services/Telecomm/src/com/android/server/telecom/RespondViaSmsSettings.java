...
public class RespondViaSmsSettings {
    // TODO: This class is newly copied into Telecomm (com.android.server.telecom) from it previous
    ...
    public static class Settings extends PreferenceActivity
        ...
        protected void onCreate(Bundle icicle) {
            ...
            window.setStatusBarColor(resource.getColor(R.color.actionbar_background_color_dark));
