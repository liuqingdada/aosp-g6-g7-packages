...
//                    } else {
//                        id = Telephony.Threads.getOrCreateThreadIdInternal(getContext(), address);
//                    }
...
//        long token = Binder.clearCallingIdentity();
//        try {
//            Xlog.d(TAG, "getAllMessagesFromIccInternational slotId =" + slotId);
...
//                    messagesActivate = smsManager.getAllMessagesFromIcc((long)slotId, PhoneConstants.PHONE_TYPE_GSM);
//                    messagesNotActivate = smsManager.getAllMessagesFromIcc((long)slotId, PhoneConstants.PHONE_TYPE_CDMA);
//                } else {
//                    messagesActivate = smsManager.getAllMessagesFromIcc(slotId, PhoneConstants.PHONE_TYPE_CDMA);
//                    messagesNotActivate = smsManager.getAllMessagesFromIcc(slotId, PhoneConstants.PHONE_TYPE_GSM);
//                }
...
//            Xlog.d(TAG, "get International cardType failed");
//            return false;
//        }
//    }
...
//                            }
//                        }
//                        cursor.addRow(convertIccToSms(message, concatSmsIndexAndBody, i, (int) si.mSimInfoId));
//                    }
//                }
//                mIsInternationalCardNotActivate = false;
...
//                            }
//                        }
//                        cursor.addRow(convertIccToSms(message, concatSmsIndexAndBody, i + countNotActivate, (int) si.mSimInfoId));
//                    }
//                }
//                return cursor;
//            }
    ...
    private long getSingleAddressId(String address, SQLiteDatabase db) {
        ...
        try {
            ...
            if (retVal == -1L) {
                ...
                Xlog.d(TAG, "getSingleAddressId: get exist id=" + retVal + ", refinedAddress="
